...
use clicky_core::sys::ipod4g::{BootKind, Model, Ipod4g, Ipod4gGdb, Ipod4gKey};
...
fn main() -> DynResult<()> {
    pretty_env_logger::formatted_builder()
        ...
        .filter(Some("LCD"), log::LevelFilter::Trace)
    ...
    let model = match args.model.as_ref() {
        "1g" | "2g" => Model::Ipod1g2g,
        "3g" => Model::Ipod3g,
        "4gcolor" => Model::Ipod4gColor,
        "5gvideo" => Model::Ipod5gVideo,
        "mini1g" => Model::IpodMini1g,
        "mini2g" => Model::IpodMini2g,
        "nano1g" => Model::IpodNano1g,
        &_ => Model::Ipod4gMono,
    };
