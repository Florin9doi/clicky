...
impl Memory for DevCon {
    fn r32(&mut self, offset: u32) -> MemResult<u32> {
        match offset {
            ...
            0xa0 => Err(StubRead(Error, self.clcd_clock_source as u32)),
    ...
    fn w32(&mut self, offset: u32, val: u32) -> MemResult<()> {
        match offset {
            ...
            0x84 => Err(StubWrite(Info, ())),
            0xa0 => Err(StubWrite(Trace, self.clcd_clock_source = val)),
            0xa4 => Err(StubWrite(Error, self.mystery_i2c = val)),
            0xc0 => Err(StubWrite(Info, ())),
